...
const istatistikler = new Discord.MessageEmbed()
  ...
  .addField(`:incoming_envelope: » Yapımcım` ,`<@767449979434172417>`,true)
 ...
 .addField(`» Linkler`, `[Destek Sunucusu](https://discord.gg/6gPNqfW6bX)`, true)
  message.channel.send(istatistikler)
  
  
}
  
exports.conf = {//Göktürk Software & Mert ☾#6954
  enabled: true,
  guildOnly: false,
  aliases: ['istatistik'],
  permLevel: 0
